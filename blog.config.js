...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '旅居时光', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的参与者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ljsg.club', // 网站地址
